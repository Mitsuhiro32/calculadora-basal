...
// Traer el peso del input cuando se hace clic en el botón "calcular"
CALCULAR.addEventListener("click", () => {
    ...
    if ( peso <= 0 || isNaN(peso)) {
        ...
        if (peso <= 30) {
            ...
            // Calcular el flujo líquido y el mantenimiento
            ...
            FLU.innerHTML = "SC x 1500: " + resultado1 + "cc" + "<br>" + "- " + fluHora1 + "cc/hr" + "<br>" + "- m+m/2: " + mantenimiento1 + "cc/hr";
